...
class AgentManager(models.Manager):
    ...
    def individuals_without_user_old(self):
        #import pdb; pdb.set_trace()
    ...
    def without_membership_request_old(self):
    ...
    def without_join_request_old(self):
