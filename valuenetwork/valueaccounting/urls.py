...
urlpatterns += [
    ...
    url(r"^add-agent-to-location/(?P<location_id>\d+)/(?P<agent_id>\d+)/$", valuenetwork.valueaccounting.views.add_agent_to_location, name="add_agent_to_location"),
    ...
    url(r'^decline-request/(?P<membership_request_id>\d+)/$', valuenetwork.valueaccounting.views.decline_request,
        name="decline_request"),
    url(r'^undecline-request/(?P<membership_request_id>\d+)/$', valuenetwork.valueaccounting.views.undecline_request,
...
if 'faircoin' in settings.INSTALLED_APPS:
    urlpatterns += [
        ...
        url(r"^validate-faircoin-address/$", valuenetwork.valueaccounting.views.validate_faircoin_address,
            name="validate_faircoin_address"),
    ]
