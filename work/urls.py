...
urlpatterns = patterns("",
    ...
    url(r'^exchanges-all/(?P<agent_id>\d+)/$', 'work.views.exchanges_all', name="exchanges_all"),
    url(r'^exchange-logging-work/(?P<context_agent_id>\d+)/(?P<exchange_type_id>\d+)/(?P<exchange_id>\d+)/$', 'work.views.exchange_logging_work',
